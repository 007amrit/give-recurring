...
function give_recurring_admin_scripts( $hook ) {
	...
	wp_register_script( 'give_admin_recurring_synchronizer', GIVE_RECURRING_PLUGIN_URL . 'assets/js/give-recurring-admin-synchronizer.min.js', array( 'jquery' ), GIVE_RECURRING_VERSION );
